...
import { Currency, CurrencyAmount, Fraction, Token, TradeType } from "@basex-fi/sdk-core";
...
import { V3Route } from "@basex-fi/smart-order-router";
...
export class DynamoRouteCachingProvider extends IRouteCachingProvider {
  ...
  private parseCachedRoutes(
    ...
    metric.putMetric(`RoutesDbBlockDifference_${TO_NETWORK_NAME()}`, blocksDifference, MetricLoggerUnit.Count);
