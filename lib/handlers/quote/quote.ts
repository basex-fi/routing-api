...
import { Currency, CurrencyAmount, TradeType, Pool } from "@basex-fi/sdk-core";
import {
  AlphaRouterConfig,
  IRouter,
  MetricLoggerUnit,
      ...
      switch (result.statusCode) {
        ...
        case 409:
          ...
          log.error(
            ...
            `Quote 4XX Error [${result?.statusCode}] on ${TO_NETWORK_NAME()} with errorCode '${result?.errorCode}': ${
              result?.detail
            }`
          );
          break;
