...
import { TO_NETWORK_NAME } from "@basex-fi/smart-order-router";
...
export class RoutingDashboardStack extends cdk.NestedStack {
  constructor(scope: Construct, name: string, props: RoutingDashboardProps) {
    ...
    const perChainWidgetsForRoutingDashboard: any[] = [
      {
        height: 8,
        width: 24,
        type: "metric",
        properties: {
          metrics: [
            ...
            "Service",
            "RoutingAPI",
            { id: `mreqc`, label: `Requests on ${TO_NETWORK_NAME()}` },
          ],
          view: "timeSeries",
          stacked: false,
          region,
      ...
      },
      {
        ...
        properties: {
          ...
          metrics: [
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_INTENT_quote`,
              "Service",
              "RoutingAPI",
              { stat: "p99.99", label: `${TO_NETWORK_NAME()} P99.99` },
            ],
            ["...", { stat: "p99.9", label: `${TO_NETWORK_NAME()} P99.9` }],
            ["...", { stat: "p99", label: `${TO_NETWORK_NAME()} P99` }],
          ],
          region,
        ...
        properties: {
          ...
          metrics: [
            [
              ...
              "Service",
              "RoutingAPI",
              { stat: "p95", label: `${TO_NETWORK_NAME()} P95` },
            ],
            ["...", { stat: "p90", label: `${TO_NETWORK_NAME()} P90` }],
          ],
          region,
        ...
        properties: {
          ...
          metrics: [
            [
              ...
              "Service",
              "RoutingAPI",
              { stat: "p50", label: `${TO_NETWORK_NAME()} Median` },
            ],
            ["...", { stat: "Average", label: `${TO_NETWORK_NAME()} Average` }],
          ],
          region,
      ...
      },
      {
        ...
        properties: {
          ...
          metrics: [
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_NTENT_quote`,
              "Service",
              "RoutingAPI",
              { stat: "Minimum", label: `${TO_NETWORK_NAME()} Minimum` },
            ],
          ],
          region,
      ...
      },
      {
        ...
        properties: {
          ...
          metrics: [
            [
              NAMESPACE,
              `GET_QUOTE_LATENCY_INTENT_caching`,
              "Service",
              "RoutingAPI",
              { stat: "p99.99", label: `${TO_NETWORK_NAME()} P99.99` },
            ],
      ...
      },
      {
        ...
        properties: {
          metrics: [
            [
              {
                expression: `(m200c$ / (mreqc - m400c)) * 100`,
                label: `Success Rate on ${TO_NETWORK_NAME()}`,
                id: `e1c`,
              },
            ],
            [
              ...
              "Service",
              "RoutingAPI",
              { id: `mreqc`, label: `Requests`, visible: false },
            ],
            [".", `GET_QUOTE_200`, ".", ".", { id: `m200c`, label: `2XX Requests`, visible: false }],
            [".", `GET_QUOTE_400`, ".", ".", { id: `m400c`, label: `4XX Errors`, visible: false }],
          ],
          view: "timeSeries",
          stacked: false,
          region,
      ...
      },
      {
        ...
        properties: {
          metrics: [
            [
              {
                expression: `(m200c / mreqc) * 100`,
                label: `Success Rate (w. 4XX) on ${TO_NETWORK_NAME()}`,
                id: `e1c`,
              },
            ],
            [
      ...
      },
      {
        ...
        properties: {
          metrics: [
            [
              {
                expression: `(m500c / mreqc) * 100`,
                label: `5XX Error Rate on ${TO_NETWORK_NAME()}`,
                id: `e1c`,
              },
            ],
            [
            ...
            [".", `GET_QUOTE_500`, ".", ".", { id: `m500c`, label: `5XX Errors`, visible: false }],
          ],
          view: "timeSeries",
          stacked: false,
          region,
      ...
      },
      {
        ...
        properties: {
          metrics: [
            [
              {
                expression: `(m400c / mreqc) * 100`,
                label: `4XX Error Rate on ${TO_NETWORK_NAME()}`,
                id: `e2c`,
              },
            ],
            [
    ...
    const rpcProvidersWidgetsForRoutingDashboard = new RpcProvidersWidgetsFactory(NAMESPACE, region).generateWidgets();
        ...
        widgets: perChainWidgetsForRoutingDashboard
          .concat([
            ...
            },
            {
              ...
              properties: {
                metrics: [
                  ["Uniswap", `QuoteFound`, "Service", "RoutingAPI"],
                  ["Uniswap", `QuoteRequested`, "Service", "RoutingAPI"],
                ],
                view: "timeSeries",
                stacked: false,
                stat: "Sum",
